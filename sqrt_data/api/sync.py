...
# [[file:../../org/core.org::*Sync][Sync:2]]
EXEC_GREP = 'grep'
EXEC_OSYNC = 'osync.sh'
EXEC_NOTIFY_SEND = 'notify-send'
# Sync:2 ends here

# [[file:../../org/core.org::*Sync][Sync:3]]
__all__ = ['sync_logs']
# Sync:3 ends here

# [[file:../../org/core.org::*Sync][Sync:4]]
def log_string():
    date_string = datetime.strftime(datetime.now(), "%Y-%m-%d")
    return f'{get_hostname()}: {date_string}'
# Sync:4 ends here

# [[file:../../org/core.org::*Sync][Sync:5]]
